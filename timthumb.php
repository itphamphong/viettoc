...
if (!defined('FILE_CACHE_ENABLED'))
    define('FILE_CACHE_ENABLED', FALSE);     // Should we store resized/modified images on disk to speed things up?
...
if (!defined('FILE_CACHE_MAX_FILE_AGE'))
    define('FILE_CACHE_MAX_FILE_AGE', 5000);    // How old does a file have to be to be deleted from the cache
