<div class="col_full fleft">
    ...
    <?php $this->load->view("back/inc/list_button",array("link"=>"admin/album"))?>
                ...
                <div class="col-xs-12">
                    ...
                    <?php foreach($this->global_function->list_tableWhere(array("status"=>1),"country") as $lang){
                        ...
                        <div class="form-group col-lang col-<?php echo $lang->name ?>">
                            ...
                            <div class="col-sm-6">
                                <input class="form-control" type="text" id="item_link_<?php echo $lang->name ?>" name="item_link_<?php echo $lang->name ?>" value="<?php echo set_value("item_link_".$lang->name,isset($item->term_link)?$item->term_link:"")?>">
