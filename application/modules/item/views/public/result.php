...
<div id="content">
    <div class="container">
        ...
        <?php $this->load->view('menu_left',array('urlp'=>'','urlc'=>''))?>
        <div id="col-right" class="col-xs-9">
            <div class="title"><?php echo "Tìm kiếm"?> <a href="<?php echo site_url($lang."/cart")?>" class="text-cart pull-right"><i class="fa fa-shopping-cart"></i> Giỏ hàng
