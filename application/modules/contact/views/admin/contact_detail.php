<div style="clear: both;"></div>
        ...
        <div class="col-xs-6 list-btn fright">
            <p style="display:none">
                <input class="a_button_act a_delete" name="delete_detail" style="cursor: pointer" type="submit"	value="Delete" />
            </p>
                ...
                <table class="table table-bordered">
                    ...
                    <?php     foreach($contact as $i){
                        ...
                        <tr class="tr-product">
                            ...
                            <td class="text-left">
                                <?php echo wordwrap($i->note, 50, "<br />\n"); ?>

                            </td>
                            <td>
                                <?php echo wordwrap($i->article, 20, "<br />\n"); ?>
                            </td>
                            <td style="text-align:center"><?php echo date('H:i:s d-m-Y',strtotime($i->date_reseive))?></td>
                            <td>
                                <a href="<?php echo base_url()?>admin/contact/delete_detail/<?php echo $i->id ?>"  class="btn default btn-sm green">
                                    <i class="fa  "></i> Xoá
                                </a>
                            </td>
                        </tr>
