    ...
    <div class="col_full fleft bs-example-bg-classes">
        <p class="bg-warning">
            <?php foreach ($this->global_function->list_tableWhere(array("status" => 1), "country") as $lang) { ?>
                ...
                <?php echo form_error('course_note_1_' . $lang->name) ?>
                <?php echo form_error('course_note_2_' . $lang->name) ?>
            <?php } ?>
        </p>
    </div>
    <div class="clear he1"></div>
                ...
                <div class="col-xs-12">
                    <?php foreach ($this->global_function->list_tableWhere(array("status" => 1), "country") as $lang) {
                        ...
                        <div class="form-group  col-lang col-<?php echo $lang->name ?>">
                            ...
                            <div class="col-xs-6">
                                <input class="form-control" type="text" name="course_name_<?php echo $lang->name ?>" value="<?php echo set_value('course_name_' . $lang->name) ?>">
                            </div>
                            <div class="clear"></div>
                        ...
                        <div class="form-group  col-lang col-<?php echo $lang->name ?>">
                            ...
                            <div class="col-xs-6">
                                <input class="form-control" type="text" name="course_note_1_<?php echo $lang->name ?>" value="<?php echo set_value('course_note_1_' . $lang->name) ?>">
                            </div>
                            <div class="clear"></div>
                        ...
                        <div class="form-group  col-lang col-<?php echo $lang->name ?>">
                            ...
                            <div class="col-xs-6">
                                <input class="form-control" type="text" name="course_note_2_<?php echo $lang->name ?>" value="<?php echo set_value('course_note_2_' . $lang->name) ?>">
                            </div>
                            <div class="clear"></div>
                        ...
                        <div class="form-group col-lang col-<?php echo $lang->name ?>">
                            ...
                            <div class="col-sm-10">
                                <?php $this->load->view("back/inc/editor", array("name" => "info_" . $lang->name)) ?>
                            </div>
                        </div>
                    <?php } ?>
                        ...
                        <div class="col-xs-6">
                                <ul class="type-teach course-type">
                                    <?php foreach ($list_degree as $de) { ?>
                                        <li class="checkbox-inline"><input type="checkbox" name="type_teach[]" id="tOnline-<?php echo  $de->id?>" value="<?php $de->id?>"  >
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-xs-6">
                            <input class="form-control" type="text" name="fee" value="0">
                        </div>
                                ...
                                <?php foreach ($list_browse as $brows) {
                                    ...
                                    <optgroup label="<?php echo $brows->browse_lession_name ?>">
                                        <?php foreach ($list_child as $child) { ?>
                                            <option  value="<?php echo $child->id ?>"><?php echo $child->browse_lession_name ?></option>
                                        <?php } ?>
                                    </optgroup>
                                <?php } ?>
                            </select>
