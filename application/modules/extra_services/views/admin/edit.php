<div class="col_full fleft">
    ...
    <?php $this->load->view("back/inc/list_button",array("link"=>"admin/extra_services"))?>
        ...
        <form class="form-horizontal" id="fileupload" method="post" enctype="multipart/form-data">
            ...
            <div class="col_full fleft info-item">
                ...
                <div class="col-xs-12">
                    ...
                    <?php foreach($this->global_function->list_tableWhere(array("status"=>1),"country") as $lang){
                        $seo=$this->global_function->show_detail_meta_seo_id_lang($id, $lang->name,"extra_services");
                        ?>
                        <div class="form-group col-lang col-<?php echo $lang->name ?>">
                            <label class="col-xs-2 control-label normal">Thẻ URL</label>

                            <div class="col-sm-6">
                                <input class="form-control" type="text" id="item_link_<?php echo $lang->name ?>" name="item_link_<?php echo $lang->name ?>" value="<?php echo set_value("item_link_".$lang->name,isset($item->extra_services_link)?$item->extra_services_link:"")?>">
