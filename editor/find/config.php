...
//$baseUrl = 'http://4net.vn/deluxe/uploads/';
$baseUrl =  ((isset($_SERVER['HTTPS']) && $_SERVER['HTTPS'] == "on") ?  "https" : "http");
$baseUrl .=  "://".$_SERVER['HTTP_HOST'];
$baseUrl .=  $_SERVER['REQUEST_URI'];
$baseUrl = str_replace('/editor/find/core/connector/php/connector.php?command=Init&type=Images', '/',$baseUrl );
$baseUrl = str_replace('/editor/find/core/connector/php/connector.php?command=Init', '/',$baseUrl );
$baseUrl = str_replace('/editor/find/core/connector/php/connector.php?command=QuickUpload'.after("QuickUpload",$baseUrl), '/',$baseUrl );
...
ATTENTION: The trailing slash is required.
*/
//$baseDir =$_SERVER['DOCUMENT_ROOT']."/gowell/uploads/";
 $path = $_SERVER["SCRIPT_FILENAME"];
 $full_path = str_replace('/editor/find/core/connector/php/connector.php', '/',$path );
 $baseDir = $full_path."uploads/";
...
$config['plugin_imageresize']['smallThumb'] = '100x100';
$config['plugin_imageresize']['mediumThumb'] = '100x100';
$config['plugin_imageresize']['largeThumb'] = '100x100';
