...
var nicEditorConfig = bkClass.extend({
    ...
    iconsPath: window.location.origin+"/findtutor"+'/themes/front/js/nicEdit/nicEditorIcons.gif',
...
var nicEditor = bkClass.extend({
    construct: function (C) {
        ...
        var A = new bkElement("DIV").setStyle({width: ($('.info-textarea').width() || B.clientWidth) + "px"}).appendBefore(B);
        this.setPanel(A);
...
var nicEditorInstance = bkClass.extend({
    isSelected: false, construct: function (G, D, C) {
        ...
        if (H || this.options.hasPanel) {
            ...
            var E = {width: newX + "px", border: "0px solid #ccc", borderTop: 0, overflowY: "auto", overflowX: "hidden"};
...
var nicEditorIFrameInstance = nicEditorInstance.extend({
    savedStyles: [], init: function () {
        ...
        this.elmFrame = new bkElement("iframe").setAttributes({src: "javascript:;", frameBorder: 0, allowTransparency: "true", scrolling: "no"}).setStyle({
            height: "100px",
            width: "100%"
    ...
    init: function () {
        ...
        for (itm in C) {
            ...
            if (A == "title") {
                ...
                switch (A) {
                    case"text":
                        this.inputs[itm] = new bkElement("input").setAttributes({id: itm, value: F, type: "text"}).setStyle({
                            margin: "2px 0",
                            fontSize: "13px",
                            "float": "left",
                            height: "20px",
